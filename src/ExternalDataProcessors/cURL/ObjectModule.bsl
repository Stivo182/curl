...
// Устанавливает построчный вывод опций при выполнении сборки команды см. СобратьКоманду
// 
// Параметры:
//  Установить - Булево - Установить
// 
// Возвращаемое значение:
//  см. ЭтотОбъект
Функция УстановитьПострочныйВыводОпций(Установить = Истина) Экспорт
	ПострочныйВыводОпций = Установить;
	Возврат ЭтотОбъект();
КонецФункции
...
Процедура УстановитьНачальныеНастройки()
	...
	УстановитьПострочныйВыводОпций(Ложь);
