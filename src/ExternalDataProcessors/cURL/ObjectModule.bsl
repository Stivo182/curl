...
// Устанавливает командный интерпретатор cmd.
// 
...
// Возвращаемое значение:
//  см. ЭтотОбъект
Функция УстановитьКомандныйИнтерпретаторCmd() Экспорт
	КомандныйИнтерпретатор = КомандныйИнтерпретаторCmd();
	Возврат ЭтотОбъект();
КонецФункции

// Устанавливает командный интерпретатор bash.
// 
// Обработка сама определяет какой командный интерпретатор использовать в зависимости от системы. 
// Данный метод будет полезен в целях сборки консольной команды с помощью метода см. СобратьКоманду.
// 
// Возвращаемое значение:
//  см. ЭтотОбъект
Функция УстановитьКомандныйИнтерпретаторBash() Экспорт
