...
Процедура ДобавитьОпциюАутентификацииBasic(Опции)
	...
	ДобавитьОпциюВСписок(Опции, "--user", СтрШаблон("%1:%2", АутентификацияBasic.ИмяПользователя, АутентификацияBasic.Пароль));
...
Процедура ДобавитьОпциюАутентификацииDigest(Опции)
	...
	ДобавитьОпциюВСписок(Опции, "--user", СтрШаблон("%1:%2", АутентификацияDigest.ИмяПользователя, АутентификацияDigest.Пароль));
...
Процедура ДобавитьОпциюАутентификацииAWS4(Опции)
	...
	Если ЗначениеЗаполнено(АутентификацияAWS4.Регион) Тогда
		Строка = Строка + ":" + АутентификацияAWS4.Регион;	
	КонецЕсли;
	
	Если ЗначениеЗаполнено(АутентификацияAWS4.Сервис) Тогда
		Строка = Строка + ":" + АутентификацияAWS4.Сервис;	
	КонецЕсли;
		
	ДобавитьОпциюВСписок(Опции, "--aws-sigv4", Строка);
	ДобавитьОпциюВСписок(Опции, "--user", СтрШаблон("%1:%2", АутентификацияAWS4.КлючДоступа, АутентификацияAWS4.СекретныйКлюч));
