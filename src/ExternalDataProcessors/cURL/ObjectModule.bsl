...
Перем СекундДляОценкиМинимальнойСкорости; // Число, Неопределено
...
//  Секунд - Число, Неопределено - Промежуток времени в секундах для оценки средней скорости. По умолчанию 30 секунд.
// 
// Возвращаемое значение:
//  см. ЭтотОбъект
Функция ПрерыватьМедленнуюПередачуДанных(МинимальнаяСкорость, Секунд = Неопределено) Экспорт
