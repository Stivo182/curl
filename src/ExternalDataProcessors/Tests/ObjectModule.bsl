...
Процедура ЗаполнитьНаборТестов(НаборТестов, КонтекстЯдраПараметр) Экспорт
	...
	#Область Post
		...
		НаборТестов.Добавить("ТестДолжен_ПроверитьПередачуПараметизированнойСтрокиНаСерверМетодомPost");
...
Процедура ТестДолжен_ПроверитьПередачуПараметизированнойСтрокиНаСерверМетодомPost() Экспорт
...
Процедура ТестДолжен_ПроверитьПередачуСтруктурыНаСерверМетодомPost() Экспорт
	...
	Тело.Вставить("Cyrillic", "Кирилица");
	...
	Ожидаем.Что(ПолученныеПараметры["Cyrillic"]).Равно("Кирилица");
